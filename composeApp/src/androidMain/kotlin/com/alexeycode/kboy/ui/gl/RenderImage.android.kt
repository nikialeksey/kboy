...
class ScreenGLRenderer(private val screen: () -> Screen) : GLSurfaceView.Renderer {
    ...
    private val quadrantCoordinatesBuffer = ByteBuffer
        .allocateDirect(QUADRANT_COORDINATES.size * 4)
        .run {
    ...
    private val textureCoordinatesBuffer = ByteBuffer
        .allocateDirect(TEXTURE_COORDINATES.size * 4)
        .run {
            order(ByteOrder.nativeOrder())
            asFloatBuffer().apply {
    ...
    private val drawOrderBuffer = ByteBuffer
        .allocateDirect(DRAW_ORDER.size * 2)
        .run {
            order(ByteOrder.nativeOrder())
            asShortBuffer().apply {
                put(DRAW_ORDER)
    ...
    override fun onSurfaceChanged(p0: GL10?, width: Int, height: Int) {
        ...
        Matrix.orthoM(projectionMatrix, 0, -80f, 80f, -72f, 72f, -1f, 1f)
    }
    ...
    override fun onDrawFrame(p0: GL10?) {
        ...
        Matrix.setLookAtM(viewMatrix, 0, 80f, 72f, 1f, 80f, 72f, 0f, 0f, 1f, 0.0f)

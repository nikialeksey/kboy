...
class Alu8Instruction(
    ...
    override fun execute(
        ...
        return when (opcode) {
            ...
            0x86 -> add({ r.a().get() }, { memory.read8(r.hl().get()) }, 8)
            0x87 -> add({ r.a().get() }, { r.a().get() }, 4)
            0xC6 -> add({ r.a().get() }, { operands[1].read8(memory, r) }, 8)
            ...
            0x8E -> adc({ r.a().get() }, { memory.read8(r.hl().get()) }, 8)
            0x8F -> adc({ r.a().get() }, { r.a().get() }, 4)
            0xCE -> adc({ r.a().get() }, { operands[1].read8(memory, r) }, 8)
            ...
            0x96 -> sub({ r.a().get() }, { memory.read8(r.hl().get()) }, 8)
            0x97 -> sub({ r.a().get() }, { r.a().get() }, 4)
            0xD6 -> sub({ r.a().get() }, { operands[1].read8(memory, r) }, 8)
            ...
            0x9E -> sbc({ r.a().get() }, { memory.read8(r.hl().get()) }, 8)
            0x9F -> sbc({ r.a().get() }, { r.a().get() }, 4)
            0xDE -> sbc({ r.a().get() }, { operands[1].read8(memory, r) }, 8)
            ...
            0xA4 -> and({ r.h().get() }, 4)
            0xA5 -> and({ r.l().get() }, 4)
            0xA6 -> and({ memory.read8(r.hl().get()) }, 8)
            0xA7 -> and({ r.a().get() }, 4)
            0xE6 -> and({ operands[1].read8(memory, r) }, 8)
            ...
            0xAC -> xor({ r.h().get() }, 4)
            0xAD -> xor({ r.l().get() }, 4)
            0xAE -> xor({ memory.read8(r.hl().get()) }, 8)
            0xAF -> xor({ r.a().get() }, 4)
            0xEE -> xor({ operands[1].read8(memory, r) }, 8)
            ...
            0xB4 -> or({ r.h().get() }, 4)
            0xB5 -> or({ r.l().get() }, 4)
            0xB6 -> or({ memory.read8(r.hl().get()) }, 8)
            0xB7 -> or({ r.a().get() }, 4)
            0xF6 -> or({ operands[1].read8(memory, r) }, 8)
            ...
            0xBC -> cp({ r.h().get() }, 4)
            0xBD -> cp({ r.l().get() }, 4)
            0xBE -> cp({ memory.read8(r.hl().get()) }, 8)
            0xBF -> cp({ r.a().get() }, 4)
            0xFE -> cp({ operands[1].read8(memory, r) }, 8)

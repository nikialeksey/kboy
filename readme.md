...
- Docs
    ...
    - https://www.inspiredpython.com/course/game-boy-emulator/let-s-write-a-game-boy-emulator-in-python - I started with it,
but then I realized, it is not enough for making performance emulator
    - https://hacktix.github.io/GBEDG/
- Opcodes
    - https://gbdev.io/gb-opcodes/optables/
    - https://github.com/meganesu/generate-gb-opcodes
